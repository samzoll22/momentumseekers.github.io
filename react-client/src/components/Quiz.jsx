...
class Quiz extends React.Component {
  ...
  render () {
        const homePage = <Container>
                        ...
                        <Row>
                            <Col>
                                <Button value="takeAction" onClick={this.handleStateChange} block size="lg" style={{height: "14vh", fontFamily: 'Coustard, serif', fontSize: "2.5rem"}} variant="warning" >Take Action ✊🏿</Button>
                                <Button value="learnMore" onClick={this.handleStateChange} block size="lg" style={{height: "14vh", fontFamily: 'Coustard, serif', marginTop: "30px", fontSize: "2.5rem"}} variant="warning">Learn More 📚</Button>
                            </Col>
                        </Row>
